...
type IndexScan struct {
	...
	TryReadbackExecutors []*Executor   `protobuf:"bytes,7,rep,name=try_readback_executors,json=tryReadbackExecutors" json:"try_readback_executors,omitempty"`
	XXX_unrecognized     []byte        `json:"-"`
}
...
func (m *IndexScan) GetTryReadbackExecutors() []*Executor {
	if m != nil {
		return m.TryReadbackExecutors
	}
	return nil
}
...
func (m *IndexScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.TryReadbackExecutors) > 0 {
		for _, msg := range m.TryReadbackExecutors {
			dAtA[i] = 0x3a
			i++
			i = encodeVarintExecutor(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *IndexScan) Size() (n int) {
	...
	if len(m.TryReadbackExecutors) > 0 {
		for _, e := range m.TryReadbackExecutors {
			l = e.Size()
			n += 1 + l + sovExecutor(uint64(l))
		}
	}
...
func (m *IndexScan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TryReadbackExecutors", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TryReadbackExecutors = append(m.TryReadbackExecutors, &Executor{})
			if err := m.TryReadbackExecutors[len(m.TryReadbackExecutors)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorExecutor = []byte{
	...
	,
}
