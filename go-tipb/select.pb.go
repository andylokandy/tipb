...
type SelectResponse struct {
	...
	TryReadbackSuccess *bool   `protobuf:"varint,11,req,name=try_readback_success,json=tryReadbackSuccess" json:"try_readback_success,omitempty"`
	XXX_unrecognized   []byte  `json:"-"`
}
...
func (m *SelectResponse) GetTryReadbackSuccess() bool {
	if m != nil && m.TryReadbackSuccess != nil {
		return *m.TryReadbackSuccess
	}
	return false
}
...
func (m *SelectResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TryReadbackSuccess == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x58
		i++
		if *m.TryReadbackSuccess {
			dAtA[i] = 1
		} else {
			dAtA[i] = 0
		}
...
func (m *SelectResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TryReadbackSuccess", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorSelect = []byte{
	...
	,
}
