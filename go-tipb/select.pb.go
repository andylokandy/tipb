...
type DAGExecutorType int32

const (
	DAGExecutorType_IndexScanExecutor DAGExecutorType = 1
	DAGExecutorType_TableScanExecutor DAGExecutorType = 2
)

var DAGExecutorType_name = map[int32]string{
	1: "IndexScanExecutor",
	2: "TableScanExecutor",
}
var DAGExecutorType_value = map[string]int32{
	"IndexScanExecutor": 1,
	"TableScanExecutor": 2,
}

func (x DAGExecutorType) Enum() *DAGExecutorType {
	p := new(DAGExecutorType)
	*p = x
	return p
}
func (x DAGExecutorType) String() string {
	return proto.EnumName(DAGExecutorType_name, int32(x))
}
func (x *DAGExecutorType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(DAGExecutorType_value, data, "DAGExecutorType")
	if err != nil {
		return err
	}
	*x = DAGExecutorType(value)
	return nil
}
func (DAGExecutorType) EnumDescriptor() ([]byte, []int) { return fileDescriptorSelect, []int{0} }
...
func (EncodeType) EnumDescriptor() ([]byte, []int) { return fileDescriptorSelect, []int{1} }
...
func (Endian) EnumDescriptor() ([]byte, []int) { return fileDescriptorSelect, []int{2} }

type DAGExecutor struct {
	Id               *uint64          `protobuf:"varint,1,req,name=id" json:"id,omitempty"`
	Type             *DAGExecutorType `protobuf:"varint,2,req,name=type,enum=tipb.DAGExecutorType" json:"type,omitempty"`
	TableScanOn      *uint64          `protobuf:"varint,3,opt,name=table_scan_on,json=tableScanOn" json:"table_scan_on,omitempty"`
	Executors        []*Executor      `protobuf:"bytes,4,rep,name=executors" json:"executors,omitempty"`
	XXX_unrecognized []byte           `json:"-"`
}

func (m *DAGExecutor) Reset()                    { *m = DAGExecutor{} }
func (m *DAGExecutor) String() string            { return proto.CompactTextString(m) }
func (*DAGExecutor) ProtoMessage()               {}
func (*DAGExecutor) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{0} }

func (m *DAGExecutor) GetId() uint64 {
	if m != nil && m.Id != nil {
		return *m.Id
	}
	return 0
...
func (m *DAGExecutor) GetType() DAGExecutorType {
	if m != nil && m.Type != nil {
		return *m.Type
	}
	return DAGExecutorType_IndexScanExecutor
}

func (m *DAGExecutor) GetTableScanOn() uint64 {
	if m != nil && m.TableScanOn != nil {
		return *m.TableScanOn
	}
	return 0
}

func (m *DAGExecutor) GetExecutors() []*Executor {
	if m != nil {
		return m.Executors
	}
	return nil
...
type SelectResponseV2 struct {
	Results          []*SelectResponse `protobuf:"bytes,1,rep,name=results" json:"results,omitempty"`
	XXX_unrecognized []byte            `json:"-"`
}

func (m *SelectResponseV2) Reset()                    { *m = SelectResponseV2{} }
func (m *SelectResponseV2) String() string            { return proto.CompactTextString(m) }
func (*SelectResponseV2) ProtoMessage()               {}
func (*SelectResponseV2) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{1} }

func (m *SelectResponseV2) GetResults() []*SelectResponse {
	if m != nil {
		return m.Results
	}
	return nil
...
func (*Row) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{2} }
...
func (*Error) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{3} }
...
type SelectResponse struct {
	...
	ExecutorId       *int64  `protobuf:"varint,11,opt,name=executor_id,json=executorId" json:"executor_id,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}
...
func (*SelectResponse) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{4} }
...
func (m *SelectResponse) GetExecutorId() int64 {
...
func (*Chunk) Descriptor() ([]byte, []int) { return fileDescriptorSelect, []int{5} }
...
type DAGRequest struct {
	...
	ExecutorsV2 []*DAGExecutor `protobuf:"bytes,18,rep,name=executorsV2" json:"executorsV2,omitempty"`
...
func (m *DAGRequest) GetExecutorsV2() []*DAGExecutor {
	if m != nil {
		return m.ExecutorsV2
	}
	return nil
}
...
func init() {
	proto.RegisterType((*DAGExecutor)(nil), "tipb.DAGExecutor")
	proto.RegisterType((*SelectResponseV2)(nil), "tipb.SelectResponseV2")
	...
	proto.RegisterEnum("tipb.DAGExecutorType", DAGExecutorType_name, DAGExecutorType_value)
...
func (m *DAGExecutor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *DAGExecutor) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Id == nil {
		...
		dAtA[i] = 0x8
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.Id))
	}
	if m.Type == nil {
		return 0, new(github_com_golang_protobuf_proto.RequiredNotSetError)
	} else {
		dAtA[i] = 0x10
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.Type))
	}
	if m.TableScanOn != nil {
		dAtA[i] = 0x18
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.TableScanOn))
	}
...
func (m *SelectResponseV2) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *SelectResponseV2) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *SelectResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ExecutorId != nil {
		dAtA[i] = 0x58
		i++
		i = encodeVarintSelect(dAtA, i, uint64(*m.ExecutorId))
	}
	if m.XXX_unrecognized != nil {
		i += copy(dAtA[i:], m.XXX_unrecognized)
	}
...
func (m *DAGRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.ExecutorsV2) > 0 {
		for _, msg := range m.ExecutorsV2 {
			dAtA[i] = 0x92
			i++
			dAtA[i] = 0x1
			i++
...
func (m *DAGExecutor) Size() (n int) {
	var l int
	_ = l
	if m.Id != nil {
		n += 1 + sovSelect(uint64(*m.Id))
	}
	if m.Type != nil {
		n += 1 + sovSelect(uint64(*m.Type))
	}
	if m.TableScanOn != nil {
		n += 1 + sovSelect(uint64(*m.TableScanOn))
	}
	if len(m.Executors) > 0 {
...
func (m *SelectResponseV2) Size() (n int) {
	var l int
	_ = l
	if len(m.Results) > 0 {
...
func (m *SelectResponse) Size() (n int) {
	...
	if m.ExecutorId != nil {
		n += 1 + sovSelect(uint64(*m.ExecutorId))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *DAGExecutor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		if wireType == 4 {
			return fmt.Errorf("proto: DAGExecutor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: DAGExecutor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= (DAGExecutorType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TableScanOn", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *SelectResponseV2) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SelectResponseV2: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SelectResponseV2: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Results = append(m.Results, &SelectResponse{})
...
func (m *DAGRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecutorsV2", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExecutorsV2 = append(m.ExecutorsV2, &DAGExecutor{})
			if err := m.ExecutorsV2[len(m.ExecutorsV2)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorSelect = []byte{
	...
	,
}
